// Kirjuta programm, mis loeb frozen.txt fali, ja kasutab falis olevaid andmeid selleks, et luua nende andmete abil objekte klassist SecretSanta.
...
{
    string[] tempArray = line.Split(new char[] { '/' }, StringSplitOptions.RemoveEmptyEntries); // Ridade lahti löömiseks
